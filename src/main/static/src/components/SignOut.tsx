...
export default ({userData, signOutStyle, device}) =>{
    ...
    if (device === 'desktop' || device === 'tab') {
        content = <span>
            <a className="nav-link" rel="noopener noreferrer" href="https://wiki.eduuni.fi/x/TlPICw" target="_blank" style={desktopStyle}>
        ...
        content = <span>
            ...
            <a className="nav-link" rel="noopener noreferrer" href="https://wiki.eduuni.fi/x/TlPICw" target="_blank" style={mobileStyle}>
