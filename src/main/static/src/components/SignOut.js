...
export default ({userData, signOutStyle, device}) =>{
    ...
    if (device === 'desktop' || device === 'tab') {
        content = <span>
            <a className="nav-link" href="https://wiki.eduuni.fi/x/xolcCw" target="_blank" style={desktopStyle}>
        ...
        content = <span>
            ...
            <a className="nav-link" href="https://wiki.eduuni.fi/x/xolcCw" target="_blank" style={mobileStyle}>
