...
export default ({userData, signOutStyle, device}) =>{
    ...
    if (device === 'desktop' || device === 'tab') {
        content = <span>
            <a className="nav-link" href="https://wiki.eduuni.fi/x/f5vTGg" target="_blank" rel="noopener noreferrer" style={desktopStyle}>
        ...
        content = <span>
            ...
            <a className="nav-link" href="https://wiki.eduuni.fi/x/f5vTGg" target="_blank" rel="noopener noreferrer" style={mobileStyle}>
