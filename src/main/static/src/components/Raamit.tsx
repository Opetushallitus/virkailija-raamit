...
export default class Raamit extends React.Component<Props, State> {
    private openTimer: any;
    private fadeInTimer: any;
    private fadeOutTimer: any;
    private closeTimer: any;
    private dataWithConcatenatedParentRoles: any[] = [];
    ...
    UNSAFE_componentWillUpdate(_nextProps: any, nextState: { userData?: any; data: any; }) {
                    ...
                    if (window.location.href.indexOf('virkailijan-tyopoyta/?ticket=') > 0) {
                        ...
                        fetch(urls["cas.prequel"], {
                            ...
                            this.userDataPromise()
                                ...
                                .catch(_err => window.location.href = urls["cas.login"] + window.location.origin + urls["virkailijan-stp-ui.etusivu"])
                        })
                    }
                }
            })
     ...
     */
    getDataWithConcatenatedParentRoles = (data: any) => {
    ...
    render() {
        ...
        const headerTabStyle: any = {
            ...headerStyle,
            height: 55,

        };

        const mobileSignOutStyle: any = {
            width: '100%',
            float: 'none',
            color: '#333333',
        ...
        const testEnvironmentAlertStyle: any = {
            display: 'inline-block',
            position: 'fixed',
            top: '10px',
            left: '-35px',
        ...
        return (
            <header
                className={`virkailija-raamit ${isTestEnvironment ? "virkailija-raamit-test" : "virkailija-raamit-production"}`}>
                {/*
                ...
                <MediaQuery minWidth={641} maxWidth={1223}>
                    <div style={headerTabStyle}>
                        ...
                        <img className="opintopolkuLogo" src={opintopolkuLogo} alt="opintopolku logo"/>
                        <div style={{float: 'right', padding: 20, paddingRight: 15, paddingTop: 5, fontSize: 20}}
